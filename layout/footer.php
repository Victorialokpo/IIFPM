<footer>
    <div class="footer-container"> <!-- ouverture container -->
        ...
        <div class="footer-social">
            <h3>Suivez nous</h3>
            <a href="https://www.facebook.com/nomdepage" target="_blank">
                <i class="fab fa-facebook-f"></i>
            </a>
            <a href="https://twitter.com/nomdetwitter" target="_blank">
        ...
        <div class="footer-newsletter">
            <h3>Newsletter</h3>
            <p>Abonnez-vous pour recevoir nos actualités et rester informé de nos actions.</p>
            <form>
